    ...
    <>
      <nav className="flex items-center justify-between p-6">
        ...
        <div className="flex space-x-4">
          ...
          <a href="#" className="text-lg">My Account</a>
        </div>
      </nav>
      {loading ? (
        <div className="flex items-center justify-center pt-64 sm:pt-72 flex-col">
          ...
          <div className="mt-8 text-2xl">Searching multiverse for an answer...</div>
        </div>
      ) : (
        <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center space-y-6 px-3 pt-32 sm:pt-64">
          <div className="flex items-center">
            <IconBolt size={36} />
            <div className="ml-1 text-center text-4xl">AI Tutor Search</div>
          </div>
          ...
          <div className="relative w-full">
            ...
            <input
              ...
              type="text"
              placeholder="Ask anything you can think of... 🕵️‍♀️💡🔍🌐"
              value={query}
